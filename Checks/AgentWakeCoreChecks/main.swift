...
struct AgentWakeCoreChecks {
    static func main() throws {
        ...
        try sessionStartDoesNotProtectDetectedProcess()
    ...
    private static func sessionStartDoesNotProtectDetectedProcess() throws {
        let baseline = Date(timeIntervalSince1970: 2_550)

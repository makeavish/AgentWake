...
if grep -Eq '^menuItem=(Lid-Closed Awake: (Off|On|Unknown|Finishing Setup)|Lid-closed sleep is disabled by another tool|Closed-Lid Mode unavailable)$' "$EVIDENCE_DIR/accessibility-menu-bar.txt"; then
